...
# How to use viSRAtoo
The misRA.R script works by taking in 3 arguments (2 SRR numbers and 1 list of genes), processes the files and outputs gene dot plots into the working directory.
